#!/bin/bash
#SBATCH --job-name=Maize_UMIcounts                                        # Job name
#SBATCH --partition=batch                                                 # Partition (queue) name
#SBATCH --ntasks=1                                                        # Single task job
#SBATCH --cpus-per-task=6                                                 # Number of cores per task
#SBATCH --mem=600gb                                                       # Total memory for job
#SBATCH --time=48:00:00                                                   # Time limit hrs:min:sec
#SBATCH --output=/scratch/jms53460/Maize_8-10_2025/SGT_UMIcounts.out      # Location of standard output file
#SBATCH --error=/scratch/jms53460/Maize_8-10_2025/SGT_UMIcounts.err       # Location of error log file
