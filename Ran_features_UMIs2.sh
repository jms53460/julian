...
#SBATCH --output=/scratch/jms53460/Ran/Ran_features_UMIs2.out              # Location of standard output file
#SBATCH --error=/scratch/jms53460/Ran/Ran_features_UMIs2.err               # Location of error log file
...
for file in "bams4/"*.bam
do
    file2="${file:6:-22}"

        umi_tools count --per-gene --gene-tag=XT --assigned-status-tag=XS -I "bams4/$file2" -S "UMIcounts3/${file2}.tsv"
done