...
featureCounts -T 6 -s 1 -a nsyl_12.gtf -t -o featurecounts/read_counts.tab --readExtension5 500 -R BAM SNPsplit/TW136xTW137_SNPsplit.bam
featureCounts -T 6 -s 1 -a nsyl_12.gtf -t -o featurecounts/read_counts_g1.tab --readExtension5 500 -R BAM SNPsplit/TW136xTW137_SNPsplit_g1.bam
featureCounts -T 6 -s 1 -a nsyl_12.gtf -t -o featurecounts/read_counts_g2.tab --readExtension5 500 -R BAM SNPsplit/TW136xTW137_SNPsplit_g2.bam
