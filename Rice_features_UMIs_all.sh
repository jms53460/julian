...
#SBATCH --output=/scratch/jms53460/Rice_RedoAnnotations/Rice_feautures_UMIs.out     # Location of standard output file
#SBATCH --error=/scratch/jms53460/Rice_RedoAnnotations/Rice_feautures_UMIs.err      # Location of error log file
