#!/bin/bash
#SBATCH --job-name=MaizeF1_4_2026_process                                 # Job name
#SBATCH --partition=batch                                                 # Partition (queue) name
#SBATCH --ntasks=1                                                        # Single task job
#SBATCH --cpus-per-task=6                                                 # Number of cores per task
#SBATCH --mem=100gb                                                       # Total memory for job
#SBATCH --time=24:00:00                                                   # Time limit hrs:min:sec
#SBATCH --output=/scratch/jms53460/MaizeF1_4_2026/Maize.out               # Location of standard output file
#SBATCH --error=/scratch/jms53460/MaizeF1_4_2026/Maize.err                # Location of error log file
